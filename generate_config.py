...
def main():
    ...
    certbot_enabled = 1 if environ['CERTBOT_ENABLED'] is None else 1 if environ['CERTBOT_ENABLED'] is True else 0

    try:
        if certbot_enabled == 1 and '--certbot' in sys.argv or len(sys.argv) == 1:
